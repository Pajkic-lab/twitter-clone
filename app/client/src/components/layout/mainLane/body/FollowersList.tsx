...
import { getFollowersThunk } from 'store/features/utileSlice/thunk'
...
export const FollowersList: React.FC = () => {
  ...
  const { followerListIsLoading, followersList, followerOffset, followerLimit, followerHasMore } = useAppSelector(
    state => state.utile,
  )
