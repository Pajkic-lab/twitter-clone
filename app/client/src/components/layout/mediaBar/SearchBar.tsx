...
import { resetSearchRespons } from 'store/features/utileSlice'
import { searchThunk } from 'store/features/utileSlice/thunk'
...
export const SearchBar: React.FC<{ InputId: string }> = ({ InputId }) => {
  ...
  const { searchRespons, searchIsLoading } = useAppSelector(state => state.utile)
