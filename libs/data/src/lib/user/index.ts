// whole user dir should be refactored and split to more sensible dirs...

export * from './user.type';

/* Requests */
export * from './request/follow-user.req.dto';
export * from './request/follower-list.req.dto';
export * from './request/following-list.req.dto';
export * from './request/name-uniqueness.req.dto';
...
export * from './request/sign-in-email.req.dto';
export * from './request/sign-up-email.req.dto';
export * from './request/toBeRefactored.req.dto';
export * from './request/un-follow-user.req.dto';
export * from './request/update-user.req.dto';
...
export * from './response/most-popular-users.res.dto';
export * from './response/name-unique-update.res.dto';
export * from './response/name-uniqueness.res.dto';
export * from './response/public-user.res.dto';
